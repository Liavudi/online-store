...
const categoriesList = [
  {id: 1, imageUrl: 'https://www.ivory.co.il/files/catalog/org/1667983814g14Im.jpg', category: 'Computers'},
  {id: 2, imageUrl: 'https://www.ivory.co.il/files/catalog/org/1661683411y11Ln.jpg', category: 'Phones'},
...
const categoriesMap = categoriesList.map((data) => {
  return (<Categories category={data.category} imageUrl={data.imageUrl} key={data.id}/> );
})
